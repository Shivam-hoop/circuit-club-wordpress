...
require_once plugin_dir_path(__FILE__) . 'includes/class-event-organizer-controller.php';
 ...
 */
function register_api_event_organizer_routes($controller_class)
{
...
add_action('rest_api_init', function () {
    register_api_event_organizer_routes('Event_Organizer_Controller');
});
